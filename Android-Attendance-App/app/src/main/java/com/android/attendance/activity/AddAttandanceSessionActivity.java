...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] subjectSEString = new String[] {"DSA","CO"};
	private String[] subjectTEString = new String[] {"DBMS","ME"};
	private String[] subjectBEString = new String[] {"BDA","AI/ML"};

	private String[] subjectFinal = new String[] {"ME","DBMS","CNS","ATC","ADP","UP"};
